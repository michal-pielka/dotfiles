  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map('glo', require('telescope.builtin').lsp_document_symbols, 'Open Document Symbols')

        -- Fuzzy find all the symbols in your current workspace.
        --  Similar to document symbols, except searches over your entire project.
        map('glw', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace Symbols')
        ...
        map('gdn', vim.diagnostic.goto_next, '[G]oto [N]ext Diagnostic')

        -- Go to the previous diagnostic
        map('gdp', vim.diagnostic.goto_prev, '[G]oto [P]revious Diagnostic')
