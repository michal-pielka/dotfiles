...
hl.bind(mainMod .. " + SHIFT + h", hl.dsp.window.move({ x = -15, y = 0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + j", hl.dsp.window.move({ x = 0, y = 15, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + k", hl.dsp.window.move({ x = 0, y = -15, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + l", hl.dsp.window.move({ x = 15, y = 0, relative = true }), { repeating = true })
...
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("~/.dotfiles/scripts/volume.sh down"),
	{ locked = true, repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("~/.dotfiles/scripts/volume.sh mute"), { locked = true })

-- Screen Brightness Control
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("~/.dotfiles/scripts/brightness.sh up"),
	{ locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("~/.dotfiles/scripts/brightness.sh down"),
	{ locked = true, repeating = true })
